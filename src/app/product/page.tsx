...
const lifecycleSteps = [
  ...
  },
  {
    ...
    subtitle: "Turn every conversation into actionable intelligence",
    description:
    ...
    features: [
      { icon: BarChart3, title: "Ratings & Outcome Tracking", desc: "Every conversation rated and tracked with resolution outcomes and quality scores." },
      { icon: Brain, title: "Evidence-Based Suggestions", desc: "Diagnostic rules generate optimization suggestions grounded in real conversation data." },
      { icon: FileCheck, title: "Knowledge & Guideline Gap Detection", desc: "Automatically surfaces missing knowledge, broken guidelines, and operational bottlenecks." },
      { icon: Zap, title: "Continuous Feedback Loop", desc: "Approved suggestions flow directly back to training — the agent improves itself every cycle." },
    ],
